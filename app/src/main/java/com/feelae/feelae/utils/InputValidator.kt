package com.feelae.feelae.utils
...
{
    fun isInputFilled(textInputValue: TextInputEditText, textInputLayout: TextInputLayout, message: String): Boolean {
        val value = textInputValue.text.toString().trim()
        if (value.isEmpty()) {
            textInputLayout.error = message
            hideKeyboardFrom(textInputValue)
            return false
        } else {
